 ...
 * 
 */
@XmlRootElement(name = "TestRadioSubscribeSyncAndNotifications")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlAddToContext
public class TestRadioSubscribeSyncAndNotifications extends DefaultCommandListener {
    ...
    public TestRadioSubscribeSyncAndNotifications() {
        secondTime = false;
    }

    public TestRadioSubscribeSyncAndNotifications(final String nodeName) {
        this.nodeName = nodeName;
        this.filename = "/"+nodeName+".xml";
    }

    private static Logger logger = LoggerFactory.getLogger(TestRadioSubscribeSyncAndNotifications.class);
