 ...
 *
 */
@XmlRootElement(name = "TestReplayLogAgedTimeEndNotifCom")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlAddToContext
public class TestReplayLogAgedTimeEndNotifCom extends DefaultCommandListener {
    ...
    public TestReplayLogAgedTimeEndNotifCom() {
        secondTime = false;
    }

    public TestReplayLogAgedTimeEndNotifCom(final String nodeName) {
        this.nodeName = nodeName;
        this.filename = "/" + nodeName + ".xml";
        this.round = 0;
    }

    private static Logger logger = LoggerFactory.getLogger(TestReplayLogAgedTimeEndNotifCom.class);
        ...
        public Boolean call() throws IOException {
            ...
            try {
                while (!Thread.currentThread().isInterrupted()) {
                    try {
                        Thread.sleep(notificationInterval > 0 ? notificationInterval : 20000);
    ...
    protected String getNotificationType(final Operation operation, final String val, final String config) {
        ...
        switch (operation) {
            ...
            case MERGE: // used for HEARTBEAT that is missing in the enum
                ...
                notificationType = "<eventTime>" + getNow() + "</eventTime>"
