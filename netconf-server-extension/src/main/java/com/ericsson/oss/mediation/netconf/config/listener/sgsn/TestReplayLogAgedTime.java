 ...
 * 
 */
@XmlRootElement(name = "TestReplayLogAgedTime")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlAddToContext
public class TestReplayLogAgedTime extends DefaultCommandListener {
    ...
    public TestReplayLogAgedTime() {
        secondTime = false;
    }

    public TestReplayLogAgedTime(final String nodeName) {
        this.nodeName = nodeName;
        this.filename = "/"+nodeName+".xml";
        this.round = 0;
    }

    private static Logger logger = LoggerFactory.getLogger(TestReplayLogAgedTime.class);
